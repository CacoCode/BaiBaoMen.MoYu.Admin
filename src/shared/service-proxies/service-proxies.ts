...
export class CommonServiceProxy {
     ...
     * @return Success
     */
    getObjectImages(objectType: string | null | undefined, objectId: number | null | undefined): Observable<GetObjectListDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetObjectListDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetObjectListDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetObjectImages(response: HttpResponseBase): Observable<GetObjectListDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(GetObjectListDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<GetObjectListDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    getObjectFiles(objectType: string | null | undefined, objectId: number | null | undefined): Observable<GetObjectListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Common/GetObjectFiles?";
        if (objectType !== undefined)
            url_ += "ObjectType=" + encodeURIComponent("" + objectType) + "&"; 
        if (objectId !== undefined)
            url_ += "ObjectId=" + encodeURIComponent("" + objectId) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetObjectFiles(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetObjectFiles(<any>response_);
                } catch (e) {
                    return <Observable<GetObjectListDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetObjectFiles(response: HttpResponseBase): Observable<GetObjectListDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class EditionServiceProxy {
     ...
     * @param onlyFreeItems (optional) 
     * @param addNotAssignedItem (optional) 
     * @return Success
     */
    getEditionComboboxItems(selectedEditionId: number | null | undefined, addAllItem: boolean | null | undefined, onlyFreeItems: boolean | null | undefined, addNotAssignedItem: boolean | null | undefined): Observable<SubscribableEditionComboboxItemDto[]> {
        ...
        if (onlyFreeItems !== undefined)
            url_ += "onlyFreeItems=" + encodeURIComponent("" + onlyFreeItems) + "&"; 
        if (addNotAssignedItem !== undefined)
            url_ += "addNotAssignedItem=" + encodeURIComponent("" + addNotAssignedItem) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    batchDelete(input: EntityDto[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Edition/BatchDelete";
        url_ = url_.replace(/[?&]$/, "");
...
export class LanguageServiceProxy {
     ...
     * @return Success
     */
    getLanguageTexts(sourceName: string, baseLanguageName: string | null | undefined, targetLanguageName: string, targetValueFilter: string | null | undefined, filterText: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined, sorting: string | null | undefined): Observable<PagedResultDtoOfLanguageTextListDto> {
...
export class OrganizationUnitServiceProxy {
     ...
     * @return Success
     */
    getOrganizationUnitUsers(id: number | null | undefined, filterText: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfOrganizationUnitUserListDto> {
...
export class RoleServiceProxy {
     ...
     * @return Success
     */
    getRoles(permissionNames: string[] | null | undefined, filterText: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfRoleListDto> {
     ...
     * @return Success
     */
    getAllRoles(): Observable<ListResultDtoOfRoleListDto> {
    ...
    protected processGetAllRoles(response: HttpResponseBase): Observable<ListResultDtoOfRoleListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getRolesToExcel(permissionNames: string[] | null | undefined, filterText: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<FileDto> {
...
export class TenantServiceProxy {
     ...
     * @return Success
     */
    updateIsActiveSwitch(input: SwitchEntityInputDtoOfInt32 | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Tenant/UpdateIsActiveSwitchAsync";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateIsActiveSwitch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateIsActiveSwitch(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateIsActiveSwitch(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    updateIsEmailConfirmedSwitch(input: SwitchEntityInputDtoOfInt32 | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/User/UpdateIsEmailConfirmedSwitchAsync";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateIsEmailConfirmedSwitch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateIsEmailConfirmedSwitch(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateIsEmailConfirmedSwitch(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    updateIsActiveSwitch(input: SwitchEntityInputDtoOfInt32 | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/User/UpdateIsActiveSwitchAsync";
        url_ = url_.replace(/[?&]$/, "");
...
export class GetObjectListDto implements IGetObjectListDto {
    id: number | undefined;
    ...
    constructor(data?: IGetObjectListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetObjectListDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetObjectListDto();
        result.init(data);
        return result;
    }
...
export interface IGetObjectListDto {
    id: number | undefined;
    isCover: boolean | undefined;
    name: string | undefined;
    fileLength: number | undefined;
...
export class AddObjectAttachmentInfosInput implements IAddObjectAttachmentInfosInput {
    ...
    clone(): AddObjectAttachmentInfosInput {
        const json = this.toJSON();
        let result = new AddObjectAttachmentInfosInput();
        result.init(json);
        return result;
...
export class SwitchEntityInputDtoOfInt32 implements ISwitchEntityInputDtoOfInt32 {
    switchValue: boolean | undefined;
    id: number | undefined;

    constructor(data?: ISwitchEntityInputDtoOfInt32) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): SwitchEntityInputDtoOfInt32 {
        data = typeof data === 'object' ? data : {};
        let result = new SwitchEntityInputDtoOfInt32();
        result.init(data);
        return result;
    }
    ...
    clone(): SwitchEntityInputDtoOfInt32 {
        const json = this.toJSON();
        let result = new SwitchEntityInputDtoOfInt32();
        result.init(json);
        return result;
...
export interface ISwitchEntityInputDtoOfInt32 {
    switchValue: boolean | undefined;
    id: number | undefined;
}
