...
export class AppUiCustomizationService {
    ...
    getTopBarMenuContainerClass(): string {
        ...
        const menuCssClass = 'm-header__bottom m-header-menu--skin-' + this.getSetting('App.UiManagement.Left.AsideSkin') + ' m-container m-container--full-height m-container--responsive';
        if (this.getSetting('App.UiManagement.LayoutType') === 'boxed') {
            return menuCssClass + ' m-container--xxl';
        }
